...
export default {
  ...
  async redirects() {
    return [
      ...
      { source: '/aanbod/kaasproeverij-utrecht', destination: '/bouwstenen/groepslunch', permanent: true },
      { source: '/aanbod/ping-pong-club', destination: '/bouwstenen/city-challenge', permanent: true },
      { source: '/aanbod/the-park-vr', destination: '/bouwstenen/city-challenge', permanent: true },
      { source: '/aanbod/boulderhal-energiehaven', destination: '/bouwstenen/city-challenge', permanent: true },
      ...
      { source: '/aanbod/doloris-anoma-maze', destination: '/bouwstenen/city-challenge', permanent: true },
      { source: '/aanbod/black-bikes-utrecht', destination: '/bouwstenen/kickbike-tocht', permanent: true },
      { source: '/aanbod/queen-escape-room', destination: '/bouwstenen/city-challenge', permanent: true },
      { source: '/aanbod/keramiek-kafee', destination: '/bouwstenen/city-challenge', permanent: true },
      { source: '/aanbod/vechtsebanen-bowling', destination: '/bouwstenen/shuffleboard', permanent: true },
      { source: '/aanbod/ruby-rose', destination: '/bouwstenen/groepslunch', permanent: true },
      { source: '/aanbod/boulderhal-sterk-spoor', destination: '/bouwstenen/city-challenge', permanent: true },
      ...
      { source: '/aanbod/padel-utrecht', destination: '/bouwstenen/city-challenge', permanent: true },
      ...
      { source: '/aanbod/boulderhal-zuidhaven', destination: '/bouwstenen/city-challenge', permanent: true },
      ...
      { source: '/aanbod/escape-domplein', destination: '/bouwstenen/city-challenge', permanent: true },
